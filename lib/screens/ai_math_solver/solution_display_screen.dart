...
/// Solution display screen showing AI-generated math solution
class SolutionDisplayScreen extends StatefulWidget {
  final File imageFile;

  const SolutionDisplayScreen({
    super.key,
    required this.imageFile,
  });

  @override
  State<SolutionDisplayScreen> createState() => _SolutionDisplayScreenState();
}

class _SolutionDisplayScreenState extends State<SolutionDisplayScreen> {
  ...
  Future<void> _analyzeMathProblem() async {
    ...
    try {
      final response = await _geminiService.solveMathFromImage(widget.imageFile);
