...
import '../../services/gemini_api_service_structured_web.dart';
import '../../widgets/latex_markdown_viewer.dart';
import '../../widgets/playful_background.dart';

/// Solution Display Screen V2 for Web with Progressive Disclosure UI
class SolutionDisplayScreenV2Web extends StatefulWidget {
  final Uint8List imageBytes;
  final String imageName;

  const SolutionDisplayScreenV2Web({
    super.key,
  ...
  @override
  State<SolutionDisplayScreenV2Web> createState() => _SolutionDisplayScreenV2WebState();
}

class _SolutionDisplayScreenV2WebState extends State<SolutionDisplayScreenV2Web> {
  final _geminiService = GeminiApiServiceStructuredWeb();
  ...
  Future<void> _analyzeProblem() async {
    try {
      ...
      final solution = await _geminiService.solveMathFromImageBytes(widget.imageBytes);
