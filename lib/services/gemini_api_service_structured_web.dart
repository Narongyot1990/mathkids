...
/// Gemini API Service with structured JSON output for math solutions (Web version)
class GeminiApiServiceStructuredWeb {
  ...
  /// Solve math problem from image bytes with structured output (Web version)
  Future<MathSolution> solveMathFromImageBytes(Uint8List imageBytes) async {
    try {
      // Convert to base64
  ...
  /// Few-shot prompt with examples for consistent structured output (same as mobile)
